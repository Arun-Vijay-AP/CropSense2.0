...
model = pickle.load(open(r"D:\CropSense\backend\random_forest_model.pkl", "rb"))
sc = pickle.load(open(r"D:\CropSense\backend\standscaler.pkl", "rb"))
ms = pickle.load(open(r"D:\CropSense\backend\minmaxscaler.pkl", "rb"))
model2 = pickle.load(open(r"D:\CropSense\backend\recommendation_model.pkl", "rb"))
lbl_enc = pickle.load(open(r"D:\CropSense\backend\crop_label_encoder.pkl", "rb"))
fert_lbl_enc = pickle.load(open(r"D:\CropSense\backend\fertilizer_label_encoder.pkl", "rb"))
